            ...
            <div class="workspace-panel overflow-hidden">
                ...
                <div class="workspace-hero px-6 md:px-8 py-6">
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        <div>
                            <p class="workspace-label">Create Record</p>
                            <h1 class="text-2xl md:text-3xl font-bold text-slate-900 mt-2">Add Sponsorship</h1>
                            <p class="text-slate-600 mt-2 text-sm md:text-base">
                                Create a new sponsorship record for a participant.
                            </p>
                        </div>
                ...
                <div class="p-6 md:p-8">
                    ...
                    @include('sponsorships.partials.form')
                </div>
            </div>
        </div>
    </div>
